...
exports.driftctlVersion = 'v0.32.1';
const driftctlChecksums = {
    'driftctl_windows_386.exe': '225de60d9179dda00780df18f168473bfc30d23222bbf87aa9ee856d65e995cf',
    driftctl_darwin_amd64: 'd8665a9d9eab5254447053e5a35be93ef6d5f42069e1b5b4083d4503cd79f572',
    driftctl_linux_386: '2469606111d599f5d72970acfccfa75ef43635c31bb4547a071514e91318ad4b',
    driftctl_linux_amd64: 'd262961eb6ee005dd65d8ad481801d3b4d30184a8b8aa03c370669729cab07a9',
    driftctl_linux_arm64: '1b04652ed21c137ec69ebf2cde2d771da3b59a6d2ddad0de31efd4375174a2b2',
    'driftctl_windows_arm64.exe': '03772784258c08a8ab6634a9801dcf7671f6648ab0f6b47a939e84364b468cb9',
    driftctl_darwin_arm64: 'c04e520a9720abddb9e35b556497bd866abe7d2e0d34180ff5275cc45e0e383e',
    'driftctl_windows_arm.exe': '65c58c0495e4a0741216cb453e37774b17a615f02e532881e2b2473a2ac83c7c',
    driftctl_linux_arm: 'd32125770fefe789695e939a9be39c371ec4e48a4743efe24edf90d4b1ee0aca',
    'driftctl_windows_amd64.exe': '46ab4c26231e01e336d35466136da72718ae51af35956875293c7f1e4e680307',
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isExe = void 0;
const fs = __webpack_require__(35747);
const fs_1 = __webpack_require__(35747);
async function isExe(path) {
    try {
        await fs_1.promises.access(path, fs.constants.X_OK);
        return true;
    }
    catch (err) {
        return false;
